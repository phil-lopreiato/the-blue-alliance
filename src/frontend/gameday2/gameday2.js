...
const store = redux_1.createStore(reducers_1.default, redux_1.compose(redux_1.applyMiddleware(redux_thunk_1.default), window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__()));
...
react_dom_1.default.render(jsx_runtime_1.jsx(MuiThemeProvider_1.default, Object.assign({ muiTheme: muiTheme }, { children: jsx_runtime_1.jsx(react_redux_1.Provider, Object.assign({ store: store }, { children: jsx_runtime_1.jsx(GamedayFrame_1.default, {}, void 0) }), void 0) }), void 0), document.getElementById("content"));
